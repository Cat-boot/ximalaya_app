...
export type IconNames = 'icon-xmlyhome' | 'icon-xmlykaishi' | 'icon-xmlylook' | 'icon-xmlyren' | 'icon-xmlywoting' | 'icon-xmlyshangyige' | 'icon-xmlyxiayige' | 'icon-xmlyzantingtingzhi';
...
let IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'icon-xmlyhome':
      return <IconXmlyhome key="1" {...rest} />;
    case 'icon-xmlykaishi':
      return <IconXmlykaishi key="2" {...rest} />;
    case 'icon-xmlylook':
      return <IconXmlylook key="3" {...rest} />;
    case 'icon-xmlyren':
      return <IconXmlyren key="4" {...rest} />;
    case 'icon-xmlywoting':
      return <IconXmlywoting key="5" {...rest} />;
    case 'icon-xmlyshangyige':
      return <IconXmlyshangyige key="6" {...rest} />;
    case 'icon-xmlyxiayige':
      return <IconXmlyxiayige key="7" {...rest} />;
    case 'icon-xmlyzantingtingzhi':
      return <IconXmlyzantingtingzhi key="8" {...rest} />;
  }
